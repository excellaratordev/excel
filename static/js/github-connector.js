(() => {
  ...
  function renderSite() {
    ...
    if (site.domain_configured) {
      ...
      detail.textContent = 'O HTML já abre pela prévia. O subdomínio será usado automaticamente após configurar o domínio wildcard.';
    }
  }
  ...
  function renderConnection(data) {
    ...
    else setMessage('HTMLs sincronizados e disponíveis para abrir. Falta somente o domínio wildcard para o subdomínio público.', 'success');
