...
- **Base 2:** seleção diretamente sobre os dados materializados.
- **Elementar:** seleciona as células de declaração; o monitor acompanha os respectivos valores do JSON ao vivo.
